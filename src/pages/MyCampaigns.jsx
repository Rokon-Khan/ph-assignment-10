              ...
              {campaigns.map((campaign) => (
                <tr key={campaign._id}>
                  ...
                  <td className="flex gap-4">
                    <Link
                      to={`/updateCampaign/${campaign?._id}`}
                      className="btn bg-green-500 text-lg font-bold text-white flex items-center"
                    >
                      Update
                      <GoArrowUpRight className="text-2xl font-bold text-green-500 rounded-full bg-white ml-2" />
                    </Link>
                    <button
                      onClick={() => handleDelte(campaign._id)}
                      className="btn btn-error text-lg font-bold text-white"
