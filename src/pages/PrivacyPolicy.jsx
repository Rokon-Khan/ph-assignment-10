    ...
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg my-10">
      ...
      <p className="mb-4">
        ...
        <ul className="list-disc pl-6">
          ...
          <li>Usage data (pages visited, time spent on the platform, etc.)</li>
        </ul>
      </p>
      ...
      <p className="mb-4">
        ...
        may share your information with trusted third parties to help us operate
        our platform and provide services, but only to the extent necessary.
      </p>
      ...
      <p className="mb-4">
        ...
        information. You may also object to the processing of your data in
        certain circumstances. To exercise these rights, please contact us.
      </p>
      ...
      <p className="mb-4">
        ...
        your information, please contact us at [Your Contact Information].
      </p>
    </div>
  );
};
