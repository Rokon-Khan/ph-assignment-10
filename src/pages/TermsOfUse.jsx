const TermsOfUse = () => {
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow-lg rounded-lg my-10">
      ...
      <p className="mb-4">
        Welcome to the Fund Raiser platform. By accessing or using our platform,
      ...
      <p className="mb-4">
        By using the Fund Raiser platform, you agree to the terms and conditions
        outlined in this Terms of Use Agreement ("Agreement"). If you do not
        agree with these terms, you are not permitted to use the platform.
      </p>
      ...
      <p className="mb-4">
        ...
        prior notice. Your continued use of the platform constitutes acceptance
        of the updated terms.
      </p>

      <h2 className="text-2xl font-semibold mb-2">3. Use of Platform</h2>
      <p className="mb-4">
        You agree to use the platform only for lawful purposes. You must not use
        the platform to engage in any illegal or fraudulent activities.
      </p>
      ...
      <p className="mb-4">
        All content on the Fund Raiser platform, including text, graphics,
        logos, and software, is the property of Fund Raiser or its licensors and
      ...
      <p className="mb-4">
        ...
        the platform at our sole discretion, without prior notice, for conduct
        that we believe violates these terms or is harmful to other users of the
        platform, us, or third parties, or for any other reason.
      </p>
      ...
      <p className="mb-4">
        Fund Raiser shall not be liable for any direct, indirect, incidental,
